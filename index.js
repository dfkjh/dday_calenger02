...
const modalMessageList = [
  { "number": 1, "message": "행복의 계절, 모두가 함께하는 12월!" },
  ...
  { "number": 7, "message": "함께 하는 즐거움, 12월 내내 계속되길 바랍니다." },
  { "number": 8, "message": "12월은 행복한 순간들이 가득한 달이에요." },
  { "number": 9, "message": "우리 모두에게 찾아온 특별한 행복의 계절!" },
  { "number": 10, "message": "매일 매일이 행복으로 가득찬 10일이 되길." },
  ...
  { "number": 23, "message": "다 함께하는 23일, 행복한 느낌이 가득할 거예요." },
